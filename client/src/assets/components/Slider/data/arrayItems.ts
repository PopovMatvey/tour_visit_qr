...
export const items = [
    {
        icon:'./images/SliderHouses/first.jpg'
    },
    {
        icon:'./images/SliderHouses/second.jpg'
    },
    {
        icon:'./images/SliderHouses/third.jpg'
    },
    // {
    //     title: "Baseball",
    //     description:
