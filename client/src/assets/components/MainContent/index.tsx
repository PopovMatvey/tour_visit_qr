...
import requestCall from "../../images/icons/call.png";
                    ...
                    <div className="footer-container">
                        ...
                        <div className="dialog">
                            ...
                            <div className="dialog-content">
                                <span>
                                    Привет! Меня зовут Ирина Гапич. Я осователь и руководитель TourStore. Обратившись к нам, вы сделали верный выбор.
                                    Организация отдыха - хоть и приятная, но очень кропотливая работа -
                                    она не прощает даже мельчайших просчётов, и лучше доверить её тому, кто занимается ей ежедневно и знает обо всех 'подводных камнях' и тонкостях
                                </span>
                            </div>
                        </div>
